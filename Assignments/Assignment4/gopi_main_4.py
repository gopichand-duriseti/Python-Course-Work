while True:
    ...
    if ch==0:
        ...
        from gopi_my_programs_4 import reverse_wrd
        reverse_wrd()

    elif ch == 2:
        from gopi_my_programs_4 import emoji
        emoji()

    elif ch == 3:
        from gopi_my_programs_4 import dec_bin
        dec_bin()

    elif ch == 4:
        from gopi_my_programs_4 import date_diff
        date_diff()

    elif ch == 5:
        from gopi_my_programs_4 import large_ele
        large_ele()

    elif ch == 6:
        from gopi_my_programs_4 import count_matches
        count_matches()

    elif ch == 7:
        from gopi_my_programs_4 import sqrs
        sqrs()

    elif ch == 8:
        from gopi_my_programs_4 import bin_anagram
        bin_anagram()

    elif ch == 9:
        from gopi_my_programs_4 import sort_tuple
        sort_tuple()

    elif ch == 10:
        from gopi_my_programs_4 import pattern
        pattern()
